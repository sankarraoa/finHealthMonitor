...
class Connection(Base):
    ...
    extra_metadata = Column(JSON, nullable=True, default=dict)  # Additional metadata as JSON
    
    # Relationships
    xero_tenants = relationship("XeroTenant", back_populates="connection", cascade="all, delete-orphan")
